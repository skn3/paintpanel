...
__skn3_paintpanel_Skn3PaintPanel_New:
	...
	add	esp,4
	mov	dword [ebx],_skn3_paintpanel_Skn3PaintPanel
	mov	dword [ebx+272],0
	mov	dword [ebx+276],0
	mov	dword [ebx+280],0
	mov	dword [ebx+284],0
...
_294:
	...
	mov	dword [esi+288],edx
	mov	eax,dword [ebp-12]
	mov	edx,dword [eax+8+24]
	mov	eax,dword [ebp-12]
	sub	edx,dword [eax+24]
	mov	dword [esi+316],edx
	mov	eax,dword [ebp-12]
	mov	edx,dword [eax+12+24]
	mov	eax,dword [ebp-12]
	sub	edx,dword [eax+4+24]
...
_403:
	...
	mov	eax,dword [esi+360]
	mov	ecx,dword [esi+332]
	mov	ecx,dword [ecx+4+24]
	mov	dword [eax+4+24],ecx
	mov	eax,dword [esi+360]
	mov	ecx,dword [esi+332]
	mov	ecx,dword [ecx+8+24]
...
__skn3_paintpanel_Skn3PaintBitmap_New:
	...
	call	_bbObjectCtor
	add	esp,4
	mov	dword [ebx],_skn3_paintpanel_Skn3PaintBitmap
	mov	dword [ebx+8],0
	mov	dword [ebx+12],0
	mov	dword [ebx+16],0
	mov	dword [ebx+20],0
